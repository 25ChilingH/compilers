# Snake game with a snake whose objective is to eat apples to grow a tail
# and not hit the walls or else the game ends.
# 
# Tools -> Bitmap Display and Keyboard and Display MMIO Simulator.
# To run, Assemble, Connect to MIPS in the above Tools, and then Run. 
# Ensure that your Bitmap Settings match the specification below and that
# your cursor is in Keyboard to play the Snake game.
#
# @author Chiling Han
...
gameUpdateLoop:
	...
	beq	$t3, 0, gameUpdateLoop		# start game moving up
